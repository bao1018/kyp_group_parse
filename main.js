...
var memberCol = ['COBRA', 'addReason', 'birthDate', 'changeDate', 'displayName', 'duplicateHRN', 'effectiveDate', 'familyHireDate', 'familyPremium', 'familySubscriberId', 'firstName', 'healthRecordNumber', 'individualHealthRecordNumber', 'lastName', 'maritalStatus', 'medicare','medicarePlanId', 'medicareEntitlementCode', 'relationshipDesc', 'relationshipDesc2', 'sex', 'status', 'subgroupId', 'zipcode'];
...
var exposeHashToCSVRow = function(cols, obj) {
	...
	cols.forEach(function(col) {
		...
		if(typeof(addedValue) =='undefined')
			addedValue = '';
...
var processSubGroup = function(subGroup) {
	...
	newRow = mainGroupId + ',' + newRow;
	mainSubGroupId = subGroup.subgroupId;
	if (strSubGroupJSON != '')
